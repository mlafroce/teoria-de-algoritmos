...
impl Digraph {
  ...
  pub fn add_indirected_weighted_edge(&mut self, src: VertexType, dst: VertexType, weight: WeightType) {
    self.add_weighted_edge(src, dst, weight);
    self.add_weighted_edge(dst, src, weight);
  }
